...
export class RecipeService{
  private recipes: Recipe[] = [
    ...
    new Recipe('Chicken Biryani', 'chicken biryani from Pakistan go boom', 'https://norecipes.com/wp-content/uploads/2017/05/chicken-biryani-12-1200x1799.jpg',
    [
      new Ingredient('Chicken', 2),
      new Ingredient('Rice', 3),
      new Ingredient('Cream', 2),
      new Ingredient('Yogurt', 2),
      new Ingredient('Boom Boom', 1)
    ])
  ];
